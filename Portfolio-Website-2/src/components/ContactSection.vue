  ...
  <div class="main">
    <div class="row">
      <div class="bg_contact">
        <!-- <img
          class="background"
          src="https://i.ibb.co/Q6t392t/hhholographic.png"
          alt="bg-image"
        /> -->
      </div>
      <!-- <img src="" alt="hhholographic" border="0"></img> -->
